 ...
 * @version 1.9
 * @LastChange $Date: 2016-05-13 14:54:19 +0200 (Fr, 13 Mai 2016) $
...
public class MutableInteger {
    ...
    public static int size() {
        // TODO Integer.SIZE (wie in Demo) oder Integer.BYTES (wie intuitiv richtig, solche Größen werden _immer_ in Byte angegeben)?;
        // In den vorliegenden Tests scheint es keinen Unterschied zu machen. Hier wird gegen die Intuition der Wert aus der Demo verwendet.
        // Es könnte ja Absicht gewesen sein.
        return Integer.SIZE;
    }
}
