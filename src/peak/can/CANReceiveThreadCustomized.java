 ...
 * @author Aragorn
 */
public class CANReceiveThreadCustomized extends Thread implements IRcvEventProcessor {
     ...
     */
    public CANReceiveThreadCustomized(PCANBasic pcanbasic, ChannelItem item/*, JTable table)*/, HashMap<Integer, TableDataRow> dataRowCollection) {
