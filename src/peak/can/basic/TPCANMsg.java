...
public class TPCANMsg implements Cloneable
{
     ...
     */
    public TPCANMsg(int id, byte type, byte length, @Nonnull byte[] data)
    {
        _id = id;
        _type = type;
        _length = length;
     ...
     * @param data the message data
     */
    public TPCANMsg(int id, @Nonnull EnumSet<TPCANMessageType> type, byte length, @Nonnull byte[] data)
    {
        _id = id;
     ...
     * @param length the message length
     */
    public void setData(@Nonnull byte[] data, byte length)
    {
        _length = length;
        System.arraycopy(data, 0, _data, 0, length);
    }
     ...
     * @param type the message type
     */
    public void setType(@Nonnull TPCANMessageType type)
    {
        _type = type.getValue();
    }
    /**
