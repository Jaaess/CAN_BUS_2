...
//import com.iav.ces.can.peak.DllExtractor;
 ...
 * applications. Steps to use this api:<br>
 * <br>
 *
 * <pre>
 ...
 * 			System.exit(0);
 * 		}
 * 		status = can.Initialize(TPCANHandle.PCAN_PCIBUS1, TPCANBaudrate.PCAN_BAUD_1M, TPCANType.PCAN_TYPE_NONE, 0,
 * 				(short) 0);
 * 		msg = new TPCANMsg();
 * 		while (true) {
...
public class PCANBasic {
	 ...
	 */
	@Nonnull
	public native TPCANStatus Initialize(@Nonnull TPCANHandle Channel, @Nonnull TPCANBaudrate Btr0Btr1,
			@Nonnull TPCANType HwType, int IOPort, short Interrupt);
	 ...
	 */
	@Nonnull
	public native TPCANStatus InitializeFD(@Nonnull TPCANHandle Channel, @Nonnull TPCANBitrateFD BitrateFD);
	 ...
	 */
	@Nonnull
	public native TPCANStatus Uninitialize(@Nonnull TPCANHandle Channel);
	 ...
	 */
	@Nonnull
	public native TPCANStatus Reset(@Nonnull TPCANHandle Channel);
	 ...
	 */
	@Nonnull
	public native TPCANStatus GetStatus(@Nonnull TPCANHandle Channel);
	 ...
	 *            A TPCANTimestamp structure buffer to get the reception time of
	 *            the message. If this value is not desired, this parameter
	 *            should be passed as NULL
	 * @return A TPCANStatus error code
	 */
	@Nonnull
	public native TPCANStatus Read(@Nonnull TPCANHandle Channel, @Nonnull TPCANMsg MessageBuffer,
			@Nullable TPCANTimestamp TimestampBuffer);
	 ...
	 * @param TimestampBuffer
	 *            A TPCANTimestampFD buffer to get the reception time of the
	 *            message
	 * @return A TPCANStatus error code
	 */
	@Nonnull
	public native TPCANStatus ReadFD(@Nonnull TPCANHandle Channel, @Nonnull TPCANMsgFD MessageBuffer,
			@Nonnull TPCANTimestampFD TimestampBuffer);
	 ...
	 */
	@Nonnull
	public native TPCANStatus Write(@Nonnull TPCANHandle Channel, @Nonnull TPCANMsg MessageBuffer);
	 ...
	 */
	@Nonnull
	public native TPCANStatus WriteFD(@Nonnull TPCANHandle Channel, @Nonnull TPCANMsgFD MessageBuffer);
	 ...
	 * @param Mode
	 *            Message type, Standard (11-bit identifier) or Extended (29-bit
	 *            identifier)
	 * @return A TPCANStatus error code
	 */
	@Nonnull
	public native TPCANStatus FilterMessages(@Nonnull TPCANHandle Channel, int FromID, int ToID,
			@Nonnull TPCANMode Mode);
	 ...
	 */
	@Nonnull
	public native TPCANStatus GetValue(@Nonnull TPCANHandle Channel, @Nonnull TPCANParameter Parameter,
			@Nonnull Object Buffer, int BufferLength);
	 ...
	 */
	@Nonnull
	public native TPCANStatus SetValue(@Nonnull TPCANHandle Channel, @Nonnull TPCANParameter Parameter,
			@Nonnull Object Buffer, int BufferLength);
	 ...
	 */
	@Nonnull
	public native TPCANStatus GetErrorText(@Nonnull TPCANStatus Error, short Language, @Nonnull StringBuffer Buffer);
	 ...
	 */
	@Nonnull
	public native TPCANStatus SetRcvEvent(@Nonnull TPCANHandle Channel);
	 ...
	 */
	@Nonnull
	public native TPCANStatus ResetRcvEvent(@Nonnull TPCANHandle Channel);
	...
	/*static {
		final Logger log = LoggerFactory.getLogger(PCANBasic.class);
		log.info("static Initialisation");

		final DllExtractor.DllInfo<Path> pcanBasicDlls = DllExtractor.getPcanBasicDlls();
		if (pcanBasicDlls != null) {
			log.info("DLLs: " + pcanBasicDlls);
			final String filenameJni = pcanBasicDlls.getJni().toString();
			final String filenameApi = pcanBasicDlls.getApi().toString();
			log.info("Initialisation: Loading PCANBasic_JNI (file: \"" + filenameJni + "\", api: \"" + filenameApi
					+ "\")");
			System.load(filenameApi);
			System.load(filenameJni);
		} else
			log.error("Initialisation failed: PCANBasic_JNI not found");
