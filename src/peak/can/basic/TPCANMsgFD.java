...
public class TPCANMsgFD implements Cloneable
{
    ...
    public TPCANMsgFD()
    {
        _type = EnumSet.noneOf(TPCANMessageType.class);
        _data = new byte[64];
    }
     ...
     */
    public TPCANMsgFD(int id, @Nonnull EnumSet<TPCANMessageType> type, byte dlc, @Nonnull byte[] data)
    {
        _id = id;
        _type = type;
        _dlc = dlc;
     ...
     */
    public void setData(@Nonnull byte[] data, byte dlc)
    {
        setDlc(dlc);
        System.arraycopy(data, 0, _data, 0, _len);
    }
     ...
     * @param type the message type
     */
    public void setType(@Nonnull EnumSet<TPCANMessageType> type)
    {
        _type = type;
    }
    ...
    {
        final EnumSet<TPCANMessageType> eset = EnumSet.noneOf(TPCANMessageType.class);
