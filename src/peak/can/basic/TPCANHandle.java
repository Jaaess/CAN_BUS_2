...
public enum TPCANHandle {
     ...
     */
    @Nonnull
    public static TPCANHandle[] initializableChannels() {
        final TPCANHandle[] src = TPCANHandle.values();
        final int srcPos = 1;
        final int destLength = src.length - srcPos;

        final TPCANHandle[] dest = new TPCANHandle[destLength];
        System.arraycopy(src, srcPos, dest, 0, destLength);
     ...
     */
    public static boolean isPCANUSBHardware(@Nonnull TPCANHandle handle) {
        switch (handle) {
            case PCAN_USBBUS1:
            case PCAN_USBBUS2:
            case PCAN_USBBUS3:
     ...
     */
    public static boolean isPCANPCCardHardware(@Nonnull TPCANHandle handle) {
        switch (handle) {
            case PCAN_PCCBUS1:
            case PCAN_PCCBUS2:
                return true;
     ...
     */
    public static boolean containsSJA(@Nonnull TPCANHandle handle, @Nonnull TPCANType type) {
        switch (handle) {
            case PCAN_DNGBUS1:
            case PCAN_ISABUS1:
            case PCAN_ISABUS2:
