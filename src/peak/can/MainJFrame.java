...
//        channelitem=new ChannelItem(TPCANHandle.PCAN_USBBUS1,TPCANType.PCAN_TYPE_ISA_SJA );
        channelitem = new ChannelItem(TPCANHandle.PCAN_USBBUS1, TPCANType.PCAN_TYPE_NONE);
    ...
    private void initComponents() {
        ...
        jComboBoxBaudrate.setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{"1000kbps", "800kbps", "500kbps", "250kbps", "125kbps", "100kbps", "50kbps"}));
    ...
    private void jButtonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConnectActionPerformed
        ...
        TPCANStatus res;
        res = pcanBasic.Initialize(TPCANHandle.PCAN_USBBUS1, TPCANBaudrate.PCAN_BAUD_100K, TPCANType.PCAN_TYPE_NONE, 100, (short) 3);
